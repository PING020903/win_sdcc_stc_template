...
#define _UNISTC_SYSCLK_H
	...
	#define P_ENXOSC 7
		...
		#ifdef STC8H8KxxU
			#define M_XCFILTER 0x0c
			#define P_XCFILTER 2
			
			#define M_GAINX 0x20
			#define P_GAINX 5
		#else // STC8H8KxxU
			#define M_XCFILTER 0x30
			#define P_XCFILTER 4
		...
		#define XCFILTER_MAX_48MHZ 0
		#define XCFILTER_MAX_24MHZ 1
		#define XCFILTER_MAX_12MHZ 2
	#endif // MCU_HAS_ENHANCED_XOSCCR

	#ifdef MCU_HAS_RTC
		// SFR X32KCR: External 32kHz oscillator control register
		SFRX(X32KCR, 0xFE08);
		#define M_X32KST 0x01
		#define P_X32KST 0
		
		#define M_GAIN32K 0x40
		#define P_GAIN32K 6
		
		#define M_ENX32K 0x80
		#define P_ENX32K 7
	#endif // MCU_HAS_RTC
	...
	#define CKSEL_HIGH_SPEED_IRC  0
	#define CKSEL_HIGH_SPEED_XTAL 1
	#define CKSEL_32KHZ_XTAL      2
	#define CKSEL_32KHZ_IRC       3
