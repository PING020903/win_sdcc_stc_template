...
#include <uni-STC/gpio/gpio3.h>
	...
	#ifndef GPIO_PRIORITY_LEVELS
		// All MCU supporting GPIO interrupts support 
		// 4 priority levels except STC8H3K64Sx.
		#define GPIO_PRIORITY_LEVELS 4
	#endif

	#if GPIO_PRIORITY_LEVELS == 4
