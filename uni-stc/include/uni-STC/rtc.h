...
#define _UNISTC_RTC_H
	...
	#define M_RTCSET 0x01
	#define P_RTCSET 0
	
	#define M_RTCCKS 0x02
	#define P_RTCCKS 1

	// SFR RTCIEN: RTC interrupt enable register
	SFRX(RTCIEN, 0xFE62);
	
	#define M_SEC32IE 0x01
	#define P_SEC32IE 0
	
	#define M_SEC8IE 0x02
	#define P_SEC8IE 1
	
	#define M_SEC2IE 0x04
	#define P_SEC2IE 2
	...
	#define M_SEC32IF 0x01
	#define P_SEC32IF 0
	
	#define M_SEC8IF 0x02
	#define P_SEC8IF 1
	
	#define M_SEC2IF 0x04
	#define P_SEC2IF 2
